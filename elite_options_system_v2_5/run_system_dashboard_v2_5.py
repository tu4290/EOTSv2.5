...
DEFAULT_CONFIG_FILENAME_V2_4 = "config_v2_5.json"
...
def initialize_its_and_dashboard_app() -> Optional[Tuple[Any, dash.Dash, Any, Optional[Callable[[], None]]]]:
    ...
    dash_mod_p = config_manager.get_setting(["runner_settings", "dashboard_module_path"], "dashboard_application.app_main_v2_5")
...
def main_v2_4():
    ...
    its_orchestrator_main, dash_app_main_v2_5, _dash_server_obj_main_unused, dashboard_cleanup_function_main = init_results
    ...
    try:
        dash_app_main_v2_5.run( # Changed from app.run to dash_app_main_v2_5.run_server
